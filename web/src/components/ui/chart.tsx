    ...
    <style
      dangerouslySetInnerHTML={{
        __html: Object.entries(config)
          ...
          .map(
            ([key, itemConfig]) =>
              `[data-chart=${id}] .color-${key} { color: ${itemConfig.color}; } [data-chart=${id}] .fill-${key} { fill: ${itemConfig.color}; } [data-chart=${id}] .stroke-${key} { stroke: ${itemConfig.color}; }`,
          )
          .join("\n"),
      }}
    />
