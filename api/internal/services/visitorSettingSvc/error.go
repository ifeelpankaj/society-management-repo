...
var (
	...
	ErrVisitorSettingsForbidden = models.NewAppError("VISITOR_SETTINGS_FORBIDDEN", "you do not have permission to manage visitor settings", http.StatusForbidden, nil)
