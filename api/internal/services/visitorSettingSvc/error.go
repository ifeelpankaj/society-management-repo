...
var (
	...
	ErrVisitorSettingsForbidden = models.NewAppError("VISITOR_SETTINGS_FORBIDDEN", "only the flat owner or society admin can manage visitor settings", http.StatusForbidden, nil)
