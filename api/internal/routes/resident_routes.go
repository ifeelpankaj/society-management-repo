...
func SetupResidentRoutesV1(rg *gin.RouterGroup, h *app.V1Handlers, g *guards.Guards) {
	...
	resident.Use(g.Authenticated()...)
	{
		...
		resident.GET("/societies/:societyId/flats/:flatId/members", h.MemberInvite.ListFlatResidentsForResident)
		resident.GET("/societies/:societyId/flats/:flatId/member-invites", h.MemberInvite.ListPendingMemberInvites)
		resident.POST("/societies/:societyId/flats/:flatId/member-invites", h.MemberInvite.CreateMemberInvite)
		resident.POST("/societies/:societyId/flats/:flatId/member-invites/:inviteId/cancel", h.MemberInvite.CancelMemberInvite)
		...
		resident.GET("/societies/:societyId/flats/:flatId/visitor-context", h.VisitorEntry.GetFlatVisitorContextForResident)
		resident.GET("/societies/:societyId/flats/:flatId/visitor-entries/pending", h.VisitorEntry.ListPendingApprovals)
		resident.GET("/societies/:societyId/flats/:flatId/visitor-entries", h.VisitorEntry.ListFlatVisitorEntries)
		resident.GET("/societies/:societyId/flats/:flatId/visitor-entries/:entryId", h.VisitorEntry.GetFlatVisitorEntry)
